...
class NavigationBarManager {
    ...
    func setNavigationBar(backgroundImage: UIImage? = nil, backgroundColor: UIColor? = nil) {
        ...
        navBar?.titleTextAttributes = [NSAttributedString.Key.font: CustomFont(fontType: .cartero, size: .extraLarge, style: .regular).uiFont, NSAttributedString.Key.foregroundColor: CustomColor.textNormal.uiColor]
